...
let rules = [n_SendReqS; n_SendReqEI; n_SendReqES; n_RecvReq; n_SendInvE; n_SendInvS; n_SendInvAck; n_RecvInvAck; n_SendGntS; n_SendGntE; n_RecvGntS; n_RecvGntE; n_Store; n_SendReqIS; n_SendReqSE; n_SendReqEI; n_SendReqES; n_SendReqEE; n_RecvReq; n_SendInvE; n_SendInvS; n_SendInvAck; n_RecvInvAck; n_SendGntS; n_SendGntE; n_RecvGntS; n_RecvGntE; n_Store]
