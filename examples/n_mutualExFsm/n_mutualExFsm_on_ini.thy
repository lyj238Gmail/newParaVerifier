(*  Title:      HOL/Auth/n_mutualExFsm_on_ini.thy
...
theory n_mutualExFsm_on_ini imports n_mutualExFsm_base
begin
...
assumes a1: "(\<exists> p__Inv0 p__Inv1. p__Inv0\<le>N\<and>p__Inv1\<le>N\<and>p__Inv0~=p__Inv1\<and>f=inv__5  p__Inv0 p__Inv1)"
and a2: "formEval (andList (allInitSpecs N)) s"
shows "formEval f s"
using a1 a2 by auto
end
