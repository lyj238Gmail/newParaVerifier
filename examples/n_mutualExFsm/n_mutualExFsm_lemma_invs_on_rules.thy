(*  Title:      HOL/Auth/n_mutualExFsm_lemma_invs_on_rules.thy
...
theory n_mutualExFsm_lemma_invs_on_rules imports n_mutualExFsm_lemma_inv__1_on_rules n_mutualExFsm_lemma_inv__2_on_rules n_mutualExFsm_lemma_inv__3_on_rules n_mutualExFsm_lemma_inv__4_on_rules n_mutualExFsm_lemma_inv__5_on_rules
begin
lemma invs_on_rules:
  ...
  apply (cut_tac a1, auto) done
    ...
    moreover {
      assume c1: "(\<exists> p__Inv0 p__Inv1. p__Inv0\<le>N\<and>p__Inv1\<le>N\<and>p__Inv0~=p__Inv1\<and>f=inv__5  p__Inv0 p__Inv1)"
      have "invHoldForRule s f r (invariants N)"
