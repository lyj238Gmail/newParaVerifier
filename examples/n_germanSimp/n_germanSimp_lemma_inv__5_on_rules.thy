(*  Title:      HOL/Auth/n_germanSimp_lemma_inv__5_on_rules.thy
...
theory n_germanSimp_lemma_inv__5_on_rules imports n_germanSimp_lemma_on_inv__5
begin
...
lemma lemma_inv__5_on_rules:
  ...
  apply (cut_tac b1, auto) done
    ...
    moreover {
      ...
      have "invHoldForRule s f r (invariants N)"
      apply (cut_tac b2 d1, metis n_RecvReqE__part__0Vsinv__5) done
    }

    moreover {
      assume d1: "(\<exists> i. i\<le>N\<and>r=n_RecvReqE__part__1 N i)"
      have "invHoldForRule s f r (invariants N)"
      apply (cut_tac b2 d1, metis n_RecvReqE__part__1Vsinv__5) done
    }
