(*  Title:      HOL/Auth/n_germanSimp_lemma_on_inv__7.thy
...
theory n_germanSimp_lemma_on_inv__7 imports n_germanSimp_base
begin
...
a2: "(\<exists> p__Inv3 p__Inv4. p__Inv3\<le>N\<and>p__Inv4\<le>N\<and>p__Inv3~=p__Inv4\<and>f=inv__7  p__Inv3 p__Inv4)"
shows "invHoldForRule s f r (invariants N)" (is "?P1 s \<or> ?P2 s \<or> ?P3 s")
proof -
from a1 obtain i where a1:"i\<le>N\<and>r=n_SendInv__part__0  i" apply fastforce done
from a2 obtain p__Inv3 p__Inv4 where a2:"p__Inv3\<le>N\<and>p__Inv4\<le>N\<and>p__Inv3~=p__Inv4\<and>f=inv__7  p__Inv3 p__Inv4" apply fastforce done
...
lemma n_RecvReqE__part__0Vsinv__7:
...
lemma n_RecvReqE__part__1Vsinv__7:
