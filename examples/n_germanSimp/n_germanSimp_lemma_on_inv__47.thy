(*  Title:      HOL/Auth/n_germanSimp_lemma_on_inv__47.thy
...
theory n_germanSimp_lemma_on_inv__47 imports n_germanSimp_base
begin
...
a2: "(\<exists> p__Inv4. p__Inv4\<le>N\<and>f=inv__47  p__Inv4)"
shows "invHoldForRule s f r (invariants N)" (is "?P1 s \<or> ?P2 s \<or> ?P3 s")
proof -
from a1 obtain i where a1:"i\<le>N\<and>r=n_RecvReqS N i" apply fastforce done
from a2 obtain p__Inv4 where a2:"p__Inv4\<le>N\<and>f=inv__47  p__Inv4" apply fastforce done
...
lemma n_RecvReqE__part__0Vsinv__47:
...
lemma n_RecvReqE__part__1Vsinv__47:
