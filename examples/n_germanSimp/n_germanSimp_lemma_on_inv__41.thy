(*  Title:      HOL/Auth/n_germanSimp_lemma_on_inv__41.thy
...
theory n_germanSimp_lemma_on_inv__41 imports n_germanSimp_base
begin
section{*All lemmas on causal relation between inv__41 and some rule r*}
lemma n_SendInvAckVsinv__41:
assumes a1: "(\<exists> i. i\<le>N\<and>r=n_SendInvAck  i)" and
a2: "(\<exists> p__Inv3 p__Inv4. p__Inv3\<le>N\<and>p__Inv4\<le>N\<and>p__Inv3~=p__Inv4\<and>f=inv__41  p__Inv3 p__Inv4)"
shows "invHoldForRule s f r (invariants N)" (is "?P1 s \<or> ?P2 s \<or> ?P3 s")
proof -
from a1 obtain i where a1:"i\<le>N\<and>r=n_SendInvAck  i" apply fastforce done
from a2 obtain p__Inv3 p__Inv4 where a2:"p__Inv3\<le>N\<and>p__Inv4\<le>N\<and>p__Inv3~=p__Inv4\<and>f=inv__41  p__Inv3 p__Inv4" apply fastforce done
...
lemma n_RecvReqE__part__0Vsinv__41:
...
lemma n_RecvReqE__part__1Vsinv__41:
