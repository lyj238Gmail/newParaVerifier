(*  Title:      HOL/Auth/n_germanSimp_base.thy
...
theory n_germanSimp_base imports paraTheory
begin
...
let g = (andForm (eqn (IVar (Field (Para (Ident ''Cache'') i) ''State'')) (Const I)) (eqn (IVar (Ident ''CurCmd'')) (Const Empty))) in
let s = (parallelList [(assign ((Ident ''CurCmd''), (Const ReqS))), (assign ((Ident ''CurPtr''), (Const (index i)))), (forallSent (down N) (\<lambda>j. (assign ((Para (Ident ''InvSet'') j), (IVar (Para (Ident ''ShrSet'') j))))))]) in
guard g s"

definition n_RecvReqE__part__0::"nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
"n_RecvReqE__part__0 N i\<equiv>
let g = (andForm (eqn (IVar (Ident ''CurCmd'')) (Const Empty)) (eqn (IVar (Field (Para (Ident ''Cache'') i) ''State'')) (Const I))) in
let s = (parallelList [(assign ((Ident ''CurCmd''), (Const ReqE))), (assign ((Ident ''CurPtr''), (Const (index i)))), (forallSent (down N) (\<lambda>j. (assign ((Para (Ident ''InvSet'') j), (IVar (Para (Ident ''ShrSet'') j))))))]) in
guard g s"

definition n_RecvReqE__part__1::"nat \<Rightarrow> nat \<Rightarrow> rule" where [simp]:
"n_RecvReqE__part__1 N i\<equiv>
let g = (andForm (eqn (IVar (Ident ''CurCmd'')) (Const Empty)) (eqn (IVar (Field (Para (Ident ''Cache'') i) ''State'')) (Const S))) in
let s = (parallelList [(assign ((Ident ''CurCmd''), (Const ReqE))), (assign ((Ident ''CurPtr''), (Const (index i)))), (forallSent (down N) (\<lambda>j. (assign ((Para (Ident ''InvSet'') j), (IVar (Para (Ident ''ShrSet'') j))))))]) in
guard g s"
...
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv4) ''State'')) (Const E)) (neg (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv3) ''State'')) (Const I)))))"

definition inv__2::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__2 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv4) ''State'')) (Const S)) (neg (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv3) ''State'')) (Const I)))) (neg (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv3) ''State'')) (Const S)))))"
...
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv3) ''State'')) (Const E)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv4) ''Cmd'')) (Const GntS))))"

definition inv__6::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__6 p__Inv3 p__Inv4 \<equiv>
...
"inv__7 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv3) ''State'')) (Const E)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv4) ''Cmd'')) (Const GntE))))"
...
"inv__12 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv3) ''Cmd'')) (Const GntS)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv4) ''Cmd'')) (Const GntE))))"
...
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv4) ''State'')) (Const E)) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv4) ''Cmd'')) (Const InvAck))))"

definition inv__16::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__16 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv3) ''State'')) (Const E)) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv4) ''Cmd'')) (Const InvAck))))"
...
"inv__26 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv4) ''State'')) (Const E)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv3) ''Cmd'')) (Const Inv))))"

definition inv__27::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__27 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv3) ''Cmd'')) (Const InvAck)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv4) ''Cmd'')) (Const GntE))))"
...
"inv__31 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv3) ''State'')) (Const E)) (eqn (IVar (Para (Ident ''InvSet'') p__Inv4)) (Const true))))"

definition inv__32::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__32 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv4) ''Cmd'')) (Const Inv)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv3) ''Cmd'')) (Const GntE))))"

definition inv__33::"nat \<Rightarrow> formula" where [simp]:
"inv__33 p__Inv4 \<equiv>
(neg (andForm (andForm (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv4) ''Cmd'')) (Const Empty)) (eqn (IVar (Para (Ident ''ShrSet'') p__Inv4)) (Const true))) (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv4) ''State'')) (Const I))) (eqn (IVar (Ident ''CurCmd'')) (Const Empty))))"
...
(neg (andForm (eqn (IVar (Ident ''ExGntd'')) (Const true)) (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv4) ''State'')) (Const S))))"
...
"inv__41 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv4) ''State'')) (Const E)) (eqn (IVar (Para (Ident ''ShrSet'') p__Inv3)) (Const true))))"

definition inv__42::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__42 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (eqn (IVar (Para (Ident ''InvSet'') p__Inv3)) (Const true)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv4) ''Cmd'')) (Const GntE))))"
...
"inv__44 p__Inv4 \<equiv>
(neg (andForm (andForm (andForm (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv4) ''Cmd'')) (Const Empty)) (eqn (IVar (Para (Ident ''ShrSet'') p__Inv4)) (Const true))) (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv4) ''State'')) (Const I))) (eqn (IVar (Ident ''CurCmd'')) (Const ReqS))) (eqn (IVar (Ident ''ExGntd'')) (Const false))))"

definition inv__45::"nat \<Rightarrow> formula" where [simp]:
"inv__45 p__Inv4 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv4) ''Cmd'')) (Const Inv)) (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv4) ''State'')) (Const I))))"

definition inv__46::"nat \<Rightarrow> formula" where [simp]:
"inv__46 p__Inv4 \<equiv>
...
"inv__48 p__Inv4 \<equiv>
(neg (andForm (andForm (eqn (IVar (Ident ''CurCmd'')) (Const ReqS)) (eqn (IVar (Ident ''ExGntd'')) (Const false))) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv4) ''Cmd'')) (Const Inv))))"
...
(neg (andForm (eqn (IVar (Para (Ident ''ShrSet'') p__Inv4)) (Const true)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv3) ''Cmd'')) (Const GntE))))"

definition inv__51::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__51 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (andForm (eqn (IVar (Para (Ident ''ShrSet'') p__Inv3)) (Const true)) (eqn (IVar (Ident ''CurCmd'')) (Const ReqS))) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv4) ''Cmd'')) (Const InvAck))))"

definition inv__52::"nat \<Rightarrow> formula" where [simp]:
"inv__52 p__Inv4 \<equiv>
(neg (andForm (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv4) ''State'')) (Const I)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv4) ''Cmd'')) (Const Empty))) (eqn (IVar (Para (Ident ''InvSet'') p__Inv4)) (Const true))))"

definition inv__53::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__53 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (andForm (eqn (IVar (Ident ''CurCmd'')) (Const ReqS)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv3) ''Cmd'')) (Const Inv))) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv4) ''Cmd'')) (Const InvAck))))"

definition inv__54::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__54 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (andForm (eqn (IVar (Para (Ident ''ShrSet'') p__Inv4)) (Const true)) (eqn (IVar (Ident ''CurCmd'')) (Const ReqS))) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv3) ''Cmd'')) (Const Inv))))"

definition inv__55::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__55 p__Inv3 p__Inv4 \<equiv>
...
"inv__56 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (andForm (eqn (IVar (Ident ''CurCmd'')) (Const ReqS)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv4) ''Cmd'')) (Const Inv))) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv3) ''Cmd'')) (Const Inv))))"

definition inv__57::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__57 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (andForm (eqn (IVar (Para (Ident ''ShrSet'') p__Inv3)) (Const true)) (eqn (IVar (Ident ''ExGntd'')) (Const true))) (eqn (IVar (Para (Ident ''InvSet'') p__Inv4)) (Const true))))"

definition inv__58::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__58 p__Inv3 p__Inv4 \<equiv>
...
definition inv__59::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__59 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (andForm (eqn (IVar (Para (Ident ''ShrSet'') p__Inv4)) (Const true)) (eqn (IVar (Ident ''ExGntd'')) (Const true))) (eqn (IVar (Para (Ident ''ShrSet'') p__Inv3)) (Const true))))"

definition inv__60::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__60 p__Inv3 p__Inv4 \<equiv>
