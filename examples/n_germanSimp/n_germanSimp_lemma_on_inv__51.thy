(*  Title:      HOL/Auth/n_germanSimp_lemma_on_inv__51.thy
...
theory n_germanSimp_lemma_on_inv__51 imports n_germanSimp_base
begin
...
lemma n_RecvReqE__part__0Vsinv__51:
...
lemma n_RecvReqE__part__1Vsinv__51:
...
moreover {
  assume b1: "(i=p__Inv4)"
  have "?P3 s"
  apply (cut_tac a1 a2 b1, simp, rule_tac x="(neg (andForm (andForm (eqn (IVar (Para (Ident ''ShrSet'') p__Inv3)) (Const true)) (eqn (IVar (Ident ''CurCmd'')) (Const ReqS))) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv4) ''Cmd'')) (Const Inv))))" in exI, auto) done
  then have "invHoldForRule s f r (invariants N)" by auto
}
moreover {
  assume b1: "(i=p__Inv3)"
