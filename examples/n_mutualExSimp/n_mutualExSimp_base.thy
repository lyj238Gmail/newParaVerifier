(*  Title:      HOL/Auth/n_mutualExSimp_base.thy
...
theory n_mutualExSimp_base imports paraTheory
begin
...
"n_Crit  i\<equiv>
let g = (andForm (eqn (IVar (Para (Ident ''n'') i)) (Const I)) (eqn (IVar (Ident ''x'')) (Const true))) in
