(*  Title:      HOL/Auth/n_germanSymIndex_lemma_inv__34_on_rules.thy
...
theory n_germanSymIndex_lemma_inv__34_on_rules imports n_germanSymIndex_lemma_on_inv__34
begin
section{*All lemmas on causal relation between inv__34*}
lemma lemma_inv__34_on_rules:
  assumes b1: "r \<in> rules N" and b2: "(\<exists> p__Inv2. p__Inv2\<le>N\<and>f=inv__34  p__Inv2)"
