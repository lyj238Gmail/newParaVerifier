(*  Title:      HOL/Auth/n_germanSymIndex_lemma_on_inv__35.thy
...
theory n_germanSymIndex_lemma_on_inv__35 imports n_germanSymIndex_base
begin
...
a2: "(\<exists> p__Inv2. p__Inv2\<le>N\<and>f=inv__35  p__Inv2)"
shows "invHoldForRule s f r (invariants N)" (is "?P1 s \<or> ?P2 s \<or> ?P3 s")
proof -
from a1 obtain i where a1:"i\<le>N\<and>r=n_RecvReqS N i" apply fastforce done
from a2 obtain p__Inv2 where a2:"p__Inv2\<le>N\<and>f=inv__35  p__Inv2" apply fastforce done
