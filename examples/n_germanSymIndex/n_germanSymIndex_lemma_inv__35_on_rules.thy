(*  Title:      HOL/Auth/n_germanSymIndex_lemma_inv__35_on_rules.thy
...
theory n_germanSymIndex_lemma_inv__35_on_rules imports n_germanSymIndex_lemma_on_inv__35
begin
section{*All lemmas on causal relation between inv__35*}
lemma lemma_inv__35_on_rules:
  assumes b1: "r \<in> rules N" and b2: "(\<exists> p__Inv2. p__Inv2\<le>N\<and>f=inv__35  p__Inv2)"
