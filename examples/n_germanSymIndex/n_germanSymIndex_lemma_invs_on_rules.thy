(*  Title:      HOL/Auth/n_germanSymIndex_lemma_invs_on_rules.thy
...
theory n_germanSymIndex_lemma_invs_on_rules imports n_germanSymIndex_lemma_inv__1_on_rules n_germanSymIndex_lemma_inv__2_on_rules n_germanSymIndex_lemma_inv__3_on_rules n_germanSymIndex_lemma_inv__4_on_rules n_germanSymIndex_lemma_inv__5_on_rules n_germanSymIndex_lemma_inv__6_on_rules n_germanSymIndex_lemma_inv__7_on_rules n_germanSymIndex_lemma_inv__8_on_rules n_germanSymIndex_lemma_inv__9_on_rules n_germanSymIndex_lemma_inv__10_on_rules n_germanSymIndex_lemma_inv__11_on_rules n_germanSymIndex_lemma_inv__12_on_rules n_germanSymIndex_lemma_inv__13_on_rules n_germanSymIndex_lemma_inv__14_on_rules n_germanSymIndex_lemma_inv__15_on_rules n_germanSymIndex_lemma_inv__16_on_rules n_germanSymIndex_lemma_inv__17_on_rules n_germanSymIndex_lemma_inv__18_on_rules n_germanSymIndex_lemma_inv__19_on_rules n_germanSymIndex_lemma_inv__20_on_rules n_germanSymIndex_lemma_inv__21_on_rules n_germanSymIndex_lemma_inv__22_on_rules n_germanSymIndex_lemma_inv__23_on_rules n_germanSymIndex_lemma_inv__24_on_rules n_germanSymIndex_lemma_inv__25_on_rules n_germanSymIndex_lemma_inv__26_on_rules n_germanSymIndex_lemma_inv__27_on_rules n_germanSymIndex_lemma_inv__28_on_rules n_germanSymIndex_lemma_inv__29_on_rules n_germanSymIndex_lemma_inv__30_on_rules n_germanSymIndex_lemma_inv__31_on_rules n_germanSymIndex_lemma_inv__32_on_rules n_germanSymIndex_lemma_inv__33_on_rules n_germanSymIndex_lemma_inv__34_on_rules n_germanSymIndex_lemma_inv__35_on_rules n_germanSymIndex_lemma_inv__36_on_rules n_germanSymIndex_lemma_inv__37_on_rules n_germanSymIndex_lemma_inv__38_on_rules n_germanSymIndex_lemma_inv__39_on_rules n_germanSymIndex_lemma_inv__40_on_rules n_germanSymIndex_lemma_inv__41_on_rules n_germanSymIndex_lemma_inv__42_on_rules n_germanSymIndex_lemma_inv__43_on_rules n_germanSymIndex_lemma_inv__44_on_rules n_germanSymIndex_lemma_inv__45_on_rules n_germanSymIndex_lemma_inv__46_on_rules n_germanSymIndex_lemma_inv__47_on_rules n_germanSymIndex_lemma_inv__48_on_rules n_germanSymIndex_lemma_inv__49_on_rules n_germanSymIndex_lemma_inv__50_on_rules n_germanSymIndex_lemma_inv__51_on_rules n_germanSymIndex_lemma_inv__52_on_rules
begin
lemma invs_on_rules:
  ...
  apply (cut_tac a1, auto) done
    ...
    moreover {
      assume c1: "(\<exists> p__Inv2. p__Inv2\<le>N\<and>f=inv__23  p__Inv2)"
      have "invHoldForRule s f r (invariants N)"
    ...
    moreover {
      assume c1: "(\<exists> p__Inv0 p__Inv2. p__Inv0\<le>N\<and>p__Inv2\<le>N\<and>p__Inv0~=p__Inv2\<and>f=inv__26  p__Inv0 p__Inv2)"
      have "invHoldForRule s f r (invariants N)"
      apply (cut_tac a2 c1, metis lemma_inv__26_on_rules) done
    }

    moreover {
      assume c1: "(\<exists> p__Inv0 p__Inv2. p__Inv0\<le>N\<and>p__Inv2\<le>N\<and>p__Inv0~=p__Inv2\<and>f=inv__27  p__Inv0 p__Inv2)"
      have "invHoldForRule s f r (invariants N)"
    ...
    moreover {
      assume c1: "(\<exists> p__Inv0 p__Inv2. p__Inv0\<le>N\<and>p__Inv2\<le>N\<and>p__Inv0~=p__Inv2\<and>f=inv__31  p__Inv0 p__Inv2)"
      have "invHoldForRule s f r (invariants N)"
      apply (cut_tac a2 c1, metis lemma_inv__31_on_rules) done
    }

    moreover {
      assume c1: "(\<exists> p__Inv0 p__Inv2. p__Inv0\<le>N\<and>p__Inv2\<le>N\<and>p__Inv0~=p__Inv2\<and>f=inv__32  p__Inv0 p__Inv2)"
      have "invHoldForRule s f r (invariants N)"
    ...
    moreover {
      assume c1: "(\<exists> p__Inv0 p__Inv2. p__Inv0\<le>N\<and>p__Inv2\<le>N\<and>p__Inv0~=p__Inv2\<and>f=inv__39  p__Inv0 p__Inv2)"
      have "invHoldForRule s f r (invariants N)"
      apply (cut_tac a2 c1, metis lemma_inv__39_on_rules) done
    }

    moreover {
      assume c1: "(\<exists> p__Inv0 p__Inv2. p__Inv0\<le>N\<and>p__Inv2\<le>N\<and>p__Inv0~=p__Inv2\<and>f=inv__40  p__Inv0 p__Inv2)"
      have "invHoldForRule s f r (invariants N)"
    ...
    moreover {
      assume c1: "(\<exists> p__Inv0 p__Inv2. p__Inv0\<le>N\<and>p__Inv2\<le>N\<and>p__Inv0~=p__Inv2\<and>f=inv__45  p__Inv0 p__Inv2)"
      have "invHoldForRule s f r (invariants N)"
      apply (cut_tac a2 c1, metis lemma_inv__45_on_rules) done
    }

    moreover {
      assume c1: "(\<exists> p__Inv0 p__Inv2. p__Inv0\<le>N\<and>p__Inv2\<le>N\<and>p__Inv0~=p__Inv2\<and>f=inv__46  p__Inv0 p__Inv2)"
      have "invHoldForRule s f r (invariants N)"
      apply (cut_tac a2 c1, metis lemma_inv__46_on_rules) done
    }

    moreover {
      assume c1: "(\<exists> p__Inv0 p__Inv2. p__Inv0\<le>N\<and>p__Inv2\<le>N\<and>p__Inv0~=p__Inv2\<and>f=inv__47  p__Inv0 p__Inv2)"
      have "invHoldForRule s f r (invariants N)"
      apply (cut_tac a2 c1, metis lemma_inv__47_on_rules) done
    }

    moreover {
      assume c1: "(\<exists> p__Inv0 p__Inv2. p__Inv0\<le>N\<and>p__Inv2\<le>N\<and>p__Inv0~=p__Inv2\<and>f=inv__48  p__Inv0 p__Inv2)"
      have "invHoldForRule s f r (invariants N)"
