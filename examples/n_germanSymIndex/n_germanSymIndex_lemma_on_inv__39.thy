(*  Title:      HOL/Auth/n_germanSymIndex_lemma_on_inv__39.thy
...
theory n_germanSymIndex_lemma_on_inv__39 imports n_germanSymIndex_base
begin
section{*All lemmas on causal relation between inv__39 and some rule r*}
lemma n_SendInvAckVsinv__39:
assumes a1: "(\<exists> i. i\<le>N\<and>r=n_SendInvAck  i)" and
a2: "(\<exists> p__Inv0 p__Inv2. p__Inv0\<le>N\<and>p__Inv2\<le>N\<and>p__Inv0~=p__Inv2\<and>f=inv__39  p__Inv0 p__Inv2)"
shows "invHoldForRule s f r (invariants N)" (is "?P1 s \<or> ?P2 s \<or> ?P3 s")
proof -
from a1 obtain i where a1:"i\<le>N\<and>r=n_SendInvAck  i" apply fastforce done
from a2 obtain p__Inv0 p__Inv2 where a2:"p__Inv0\<le>N\<and>p__Inv2\<le>N\<and>p__Inv0~=p__Inv2\<and>f=inv__39  p__Inv0 p__Inv2" apply fastforce done
