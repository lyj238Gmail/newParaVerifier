...
let init =  (parallel [
    (assign (record [ global "Sta"; global "MemData";]) (param (paramfix "d" "DATA" (intc 1))));
    ...
    (assign (record [ global "Sta"; global "Dir"; global "HeadPtr";]) (param (paramfix "h" "NODE" (intc 1))));
    (assign (record [ global "Sta"; global "Dir"; global "HomeHeadPtr";]) (const _TRUE));
    ...
    (assign (record [ global "Sta"; global "WbMsg"; global "Proc";]) (param (paramfix "h" "NODE" (intc 1))));
    (assign (record [ global "Sta"; global "WbMsg"; global "HomeProc";]) (const _TRUE));
    (assign (record [ global "Sta"; global "WbMsg"; global "Data";]) (param (paramfix "d" "DATA" (intc 1))));
    (assign (record [ global "Sta"; global "ShWbMsg"; global "Cmd";]) (const _SHWB_None));
    (assign (record [ global "Sta"; global "ShWbMsg"; global "Proc";]) (param (paramfix "h" "NODE" (intc 1))));
    (assign (record [ global "Sta"; global "ShWbMsg"; global "HomeProc";]) (const _TRUE));
    (assign (record [ global "Sta"; global "ShWbMsg"; global "Data";]) (param (paramfix "d" "DATA" (intc 1))));
    ...
    (forStatement  (parallel [
        ...
        (assign (record [ global "Sta"; arr [("Proc", [paramref "p"])] ; global "CacheData";]) (param (paramfix "d" "DATA" (intc 1))));
        ...
        (assign (record [ global "Sta"; arr [("UniMsg", [paramref "p"])] ; global "Proc";]) (param (paramfix "h" "NODE" (intc 1))));
        (assign (record [ global "Sta"; arr [("UniMsg", [paramref "p"])] ; global "HomeProc";]) (const _TRUE));
        (assign (record [ global "Sta"; arr [("UniMsg", [paramref "p"])] ; global "Data";]) (param (paramfix "d" "DATA" (intc 1))));
        (assign (record [ global "Sta"; arr [("InvMsg", [paramref "p"])] ; global "Cmd";]) (const _INV_None));
        (assign (record [ global "Sta"; arr [("RpMsg", [paramref "p"])] ; global "Cmd";]) (const _RP_None))]) [paramdef "p" "NODE"]);
    (assign (record [ global "Sta"; global "HomeProc"; global "ProcCmd";]) (const _NODE_None));
    (assign (record [ global "Sta"; global "HomeProc"; global "InvMarked";]) (const _FALSE));
    (assign (record [ global "Sta"; global "HomeProc"; global "CacheState";]) (const _CACHE_I));
    (assign (record [ global "Sta"; global "HomeProc"; global "CacheData";]) (param (paramfix "d" "DATA" (intc 1))));
    (assign (record [ global "Sta"; global "Dir"; global "HomeShrSet";]) (const _FALSE));
    (assign (record [ global "Sta"; global "Dir"; global "HomeInvSet";]) (const _FALSE));
    (assign (record [ global "Sta"; global "HomeUniMsg"; global "Cmd";]) (const _UNI_None));
    (assign (record [ global "Sta"; global "HomeUniMsg"; global "Proc";]) (param (paramfix "h" "NODE" (intc 1))));
    (assign (record [ global "Sta"; global "HomeUniMsg"; global "HomeProc";]) (const _TRUE));
    (assign (record [ global "Sta"; global "HomeUniMsg"; global "Data";]) (param (paramfix "d" "DATA" (intc 1))));
    (assign (record [ global "Sta"; global "HomeInvMsg"; global "Cmd";]) (const _INV_None));
    (assign (record [ global "Sta"; global "HomeRpMsg"; global "Cmd";]) (const _RP_None));
    (assign (record [ global "Sta"; global "CurrData";]) (param (paramfix "d" "DATA" (intc 1))))])
...
let n_Store = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; arr [("Proc", [paramref "src"])] ; global "CacheData";]) (param (paramref "data")));
       (assign (record [ global "Sta"; global "CurrData";]) (param (paramref "data")))]) in
...
let n_Store_Home = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; global "HomeProc"; global "CacheData";]) (param (paramref "data")));
       (assign (record [ global "Sta"; global "CurrData";]) (param (paramref "data")))]) in
   rule name params formula statement
...
let n_PI_Remote_Get = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; arr [("Proc", [paramref "src"])] ; global "ProcCmd";]) (const _NODE_Get));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Cmd";]) (const _UNI_Get));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "HomeProc";]) (const _TRUE))]) in
   rule name params formula statement
...
let n_PI_Local_Get_Get = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; global "HomeProc"; global "ProcCmd";]) (const _NODE_Get));
       (assign (record [ global "Sta"; global "Dir"; global "Pending";]) (const _TRUE));
       (assign (record [ global "Sta"; global "HomeUniMsg"; global "Cmd";]) (const _UNI_Get));
       (assign (record [ global "Sta"; global "HomeUniMsg"; global "Proc";]) (var (record [ global "Sta"; global "Dir"; global "HeadPtr";])));
       (assign (record [ global "Sta"; global "HomeUniMsg"; global "HomeProc";]) (var (record [ global "Sta"; global "Dir"; global "HomeHeadPtr";])))]) in
   rule name params formula statement
...
let n_PI_Local_Get_Put = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; global "Dir"; global "Local";]) (const _TRUE));
       (assign (record [ global "Sta"; global "HomeProc"; global "ProcCmd";]) (const _NODE_None));
       (ifelseStatement  (eqn (var ( record [ global "Sta"; global "HomeProc"; global "InvMarked";])) (const _TRUE)) (parallel [
               (assign (record [ global "Sta"; global "HomeProc"; global "InvMarked";]) (const _FALSE));
               (assign (record [ global "Sta"; global "HomeProc"; global "CacheState";]) (const _CACHE_I))]) (parallel [
           (assign (record [ global "Sta"; global "HomeProc"; global "CacheState";]) (const _CACHE_S));
           (assign (record [ global "Sta"; global "HomeProc"; global "CacheData";]) (var (record [ global "Sta"; global "MemData";])))]))]) in
   rule name params formula statement
...
let n_PI_Remote_GetX = 
   ...
   let formula =  (andList [ (eqn (var (record [ global "Sta"; arr [("Proc", [paramref "src"])] ; global "ProcCmd";])) (const _NODE_None));  (eqn (var (record [ global "Sta"; arr [("Proc", [paramref "src"])] ; global "CacheState";])) (const _CACHE_I))]) in
   let statement =  (parallel [
       (assign (record [ global "Sta"; arr [("Proc", [paramref "src"])] ; global "ProcCmd";]) (const _NODE_GetX));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Cmd";]) (const _UNI_GetX));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "HomeProc";]) (const _TRUE))]) in
   rule name params formula statement
...
let n_PI_Local_GetX_GetX = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; global "HomeProc"; global "ProcCmd";]) (const _NODE_GetX));
       (assign (record [ global "Sta"; global "Dir"; global "Pending";]) (const _TRUE));
       (assign (record [ global "Sta"; global "HomeUniMsg"; global "Cmd";]) (const _UNI_GetX));
       (assign (record [ global "Sta"; global "HomeUniMsg"; global "Proc";]) (var (record [ global "Sta"; global "Dir"; global "HeadPtr";])));
       (assign (record [ global "Sta"; global "HomeUniMsg"; global "HomeProc";]) (var (record [ global "Sta"; global "Dir"; global "HomeHeadPtr";])))]) in
   rule name params formula statement
...
let n_PI_Local_GetX_PutX_HeadVld = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; global "Dir"; global "Local";]) (const _TRUE));
       (assign (record [ global "Sta"; global "Dir"; global "Dirty";]) (const _TRUE));
       (assign (record [ global "Sta"; global "Dir"; global "Pending";]) (const _TRUE));
       (assign (record [ global "Sta"; global "Dir"; global "HeadVld";]) (const _FALSE));
       (assign (record [ global "Sta"; global "Dir"; global "ShrVld";]) (const _FALSE));
       (forStatement  (parallel [
           (assign (record [ global "Sta"; global "Dir"; arr [("ShrSet", [paramref "p"])] ;]) (const _FALSE));
           (ifelseStatement  (orList [ (andList [ (eqn (var ( record [ global "Sta"; global "Dir"; global "ShrVld";])) (const _TRUE)); (eqn (var (record [ global "Sta"; global "Dir"; arr [("ShrSet", [paramref "p"])] ;])) (const _TRUE))]);  (andList [ (eqn (var (record [ global "Sta"; global "Dir"; global "HeadPtr";])) (param (paramref "p"))); (eqn (var ( record [ global "Sta"; global "Dir"; global "HomeHeadPtr";])) (const _FALSE))])]) (parallel [
                   (assign (record [ global "Sta"; global "Dir"; arr [("InvSet", [paramref "p"])] ;]) (const _TRUE));
                   (assign (record [ global "Sta"; arr [("InvMsg", [paramref "p"])] ; global "Cmd";]) (const _INV_Inv))]) (parallel [
               (assign (record [ global "Sta"; global "Dir"; arr [("InvSet", [paramref "p"])] ;]) (const _FALSE));
               (assign (record [ global "Sta"; arr [("InvMsg", [paramref "p"])] ; global "Cmd";]) (const _INV_None))]))]) [paramdef "p" "NODE"]);
       (assign (record [ global "Sta"; global "Dir"; global "HomeShrSet";]) (const _FALSE));
       (assign (record [ global "Sta"; global "Dir"; global "HomeInvSet";]) (const _FALSE));
       (assign (record [ global "Sta"; global "HomeInvMsg"; global "Cmd";]) (const _INV_None));
       (assign (record [ global "Sta"; global "HomeProc"; global "ProcCmd";]) (const _NODE_None));
       (assign (record [ global "Sta"; global "HomeProc"; global "InvMarked";]) (const _FALSE));
       (assign (record [ global "Sta"; global "HomeProc"; global "CacheState";]) (const _CACHE_E));
       (assign (record [ global "Sta"; global "HomeProc"; global "CacheData";]) (var (record [ global "Sta"; global "MemData";])))]) in
   rule name params formula statement
...
let n_PI_Remote_PutX = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "CacheState";]) (const _CACHE_I));
       (assign (record [ global "Sta"; global "WbMsg"; global "Cmd";]) (const _WB_Wb));
       (assign (record [ global "Sta"; global "WbMsg"; global "Proc";]) (param (paramref "dst")));
       (assign (record [ global "Sta"; global "WbMsg"; global "HomeProc";]) (const _FALSE));
       (assign (record [ global "Sta"; global "WbMsg"; global "Data";]) (var (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "CacheData";])))]) in
   rule name params formula statement
...
let n_PI_Local_PutX = 
   ...
   let statement = 
       (ifelseStatement  (eqn (var ( record [ global "Sta"; global "Dir"; global "Pending";])) (const _TRUE)) (parallel [
               (assign (record [ global "Sta"; global "HomeProc"; global "CacheState";]) (const _CACHE_I));
               (assign (record [ global "Sta"; global "Dir"; global "Dirty";]) (const _FALSE));
               (assign (record [ global "Sta"; global "MemData";]) (var (record [ global "Sta"; global "HomeProc"; global "CacheData";])))]) (parallel [
           (assign (record [ global "Sta"; global "HomeProc"; global "CacheState";]) (const _CACHE_I));
           (assign (record [ global "Sta"; global "Dir"; global "Local";]) (const _FALSE));
           (assign (record [ global "Sta"; global "Dir"; global "Dirty";]) (const _FALSE));
           (assign (record [ global "Sta"; global "MemData";]) (var (record [ global "Sta"; global "HomeProc"; global "CacheData";])))])) in
   rule name params formula statement
...
let n_PI_Remote_Replace = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; arr [("Proc", [paramref "src"])] ; global "CacheState";]) (const _CACHE_I));
       (assign (record [ global "Sta"; arr [("RpMsg", [paramref "src"])] ; global "Cmd";]) (const _RP_Replace))]) in
   rule name params formula statement
...
let n_PI_Local_Replace = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; global "Dir"; global "Local";]) (const _FALSE));
       (assign (record [ global "Sta"; global "HomeProc"; global "CacheState";]) (const _CACHE_I))]) in
   rule name params formula statement
...
let n_NI_Nak = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "dst"])] ; global "Cmd";]) (const _UNI_None));
       (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "ProcCmd";]) (const _NODE_None));
       (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "InvMarked";]) (const _FALSE))]) in
   rule name params formula statement
...
let n_NI_Nak_Home = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; global "HomeUniMsg"; global "Cmd";]) (const _UNI_None));
       (assign (record [ global "Sta"; global "HomeProc"; global "ProcCmd";]) (const _NODE_None));
       (assign (record [ global "Sta"; global "HomeProc"; global "InvMarked";]) (const _FALSE))]) in
   rule name params formula statement
...
let n_NI_Nak_Clear = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; global "NakcMsg"; global "Cmd";]) (const _NAKC_None));
       (assign (record [ global "Sta"; global "Dir"; global "Pending";]) (const _FALSE))]) in
   rule name params formula statement
...
let n_NI_Local_Get_Nak = 
   ...
   let statement = 
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Cmd";]) (const _UNI_Nak)) in
   rule name params formula statement
...
let n_NI_Local_Get_Get = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; global "Dir"; global "Pending";]) (const _TRUE));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Cmd";]) (const _UNI_Get));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Proc";]) (var (record [ global "Sta"; global "Dir"; global "HeadPtr";])));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "HomeProc";]) (var (record [ global "Sta"; global "Dir"; global "HomeHeadPtr";])))]) in
   rule name params formula statement
...
let n_NI_Local_Get_Put_Head = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; global "Dir"; global "ShrVld";]) (const _TRUE));
       (assign (record [ global "Sta"; global "Dir"; arr [("ShrSet", [paramref "src"])] ;]) (const _TRUE));
       (forStatement 
           (ifelseStatement  (eqn (param (paramref "p")) (param (paramref "src")))
                   (assign (record [ global "Sta"; global "Dir"; arr [("InvSet", [paramref "p"])] ;]) (const _TRUE))
               (assign (record [ global "Sta"; global "Dir"; arr [("InvSet", [paramref "p"])] ;]) (var (record [ global "Sta"; global "Dir"; arr [("ShrSet", [paramref "p"])] ;])))) [paramdef "p" "NODE"]);
       (assign (record [ global "Sta"; global "Dir"; global "HomeInvSet";]) (var (record [ global "Sta"; global "Dir"; global "HomeShrSet";])));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Cmd";]) (const _UNI_Put));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Data";]) (var (record [ global "Sta"; global "MemData";])))]) in
   rule name params formula statement
...
let n_NI_Local_Get_Put = 
   ...
   let formula =  (andList [ (andList [ (andList [ (andList [ (andList [ (eqn (var (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Cmd";])) (const _UNI_Get)); (eqn (var ( record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "HomeProc";])) (const _TRUE))]);  (neg (eqn (var (record [ global "Sta"; arr [("RpMsg", [paramref "src"])] ; global "Cmd";])) (const _RP_Replace)))]); (eqn (var ( record [ global "Sta"; global "Dir"; global "Pending";])) (const _FALSE))]); (eqn (var ( record [ global "Sta"; global "Dir"; global "Dirty";])) (const _FALSE))]); (eqn (var ( record [ global "Sta"; global "Dir"; global "HeadVld";])) (const _FALSE))]) in
   let statement =  (parallel [
       (assign (record [ global "Sta"; global "Dir"; global "HeadVld";]) (const _TRUE));
       (assign (record [ global "Sta"; global "Dir"; global "HeadPtr";]) (param (paramref "src")));
       (assign (record [ global "Sta"; global "Dir"; global "HomeHeadPtr";]) (const _FALSE));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Cmd";]) (const _UNI_Put));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Data";]) (var (record [ global "Sta"; global "MemData";])))]) in
   rule name params formula statement
...
let n_NI_Local_Get_Put_Dirty = 
   ...
   let statement =  (parallel [
       ...
       (assign (record [ global "Sta"; global "Dir"; global "HeadPtr";]) (param (paramref "src")));
       (assign (record [ global "Sta"; global "Dir"; global "HomeHeadPtr";]) (const _FALSE));
       (assign (record [ global "Sta"; global "MemData";]) (var (record [ global "Sta"; global "HomeProc"; global "CacheData";])));
       (assign (record [ global "Sta"; global "HomeProc"; global "CacheState";]) (const _CACHE_S));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Cmd";]) (const _UNI_Put));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Data";]) (var (record [ global "Sta"; global "HomeProc"; global "CacheData";])))]) in
   rule name params formula statement
...
let n_NI_Remote_Get_Nak = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Cmd";]) (const _UNI_Nak));
       (assign (record [ global "Sta"; global "NakcMsg"; global "Cmd";]) (const _NAKC_Nakc))]) in
   rule name params formula statement
...
let n_NI_Remote_Get_Nak_Home = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; global "HomeUniMsg"; global "Cmd";]) (const _UNI_Nak));
       (assign (record [ global "Sta"; global "NakcMsg"; global "Cmd";]) (const _NAKC_Nakc))]) in
   rule name params formula statement
...
let n_NI_Remote_Get_Put = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "CacheState";]) (const _CACHE_S));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Cmd";]) (const _UNI_Put));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Data";]) (var (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "CacheData";])));
       (assign (record [ global "Sta"; global "ShWbMsg"; global "Cmd";]) (const _SHWB_ShWb));
       (assign (record [ global "Sta"; global "ShWbMsg"; global "Proc";]) (param (paramref "src")));
       (assign (record [ global "Sta"; global "ShWbMsg"; global "HomeProc";]) (const _FALSE));
       (assign (record [ global "Sta"; global "ShWbMsg"; global "Data";]) (var (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "CacheData";])))]) in
   rule name params formula statement
...
let n_NI_Remote_Get_Put_Home = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "CacheState";]) (const _CACHE_S));
       (assign (record [ global "Sta"; global "HomeUniMsg"; global "Cmd";]) (const _UNI_Put));
       (assign (record [ global "Sta"; global "HomeUniMsg"; global "Data";]) (var (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "CacheData";])))]) in
   rule name params formula statement
...
let n_NI_Local_GetX_PutX_1 = 
   ...
   let statement =  (parallel [
       ...
       (forStatement  (parallel [
           (assign (record [ global "Sta"; global "Dir"; arr [("ShrSet", [paramref "p"])] ;]) (const _FALSE));
           (assign (record [ global "Sta"; global "Dir"; arr [("InvSet", [paramref "p"])] ;]) (const _FALSE))]) [paramdef "p" "NODE"]);
       (assign (record [ global "Sta"; global "Dir"; global "HomeShrSet";]) (const _FALSE));
       (assign (record [ global "Sta"; global "Dir"; global "HomeInvSet";]) (const _FALSE));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Cmd";]) (const _UNI_PutX));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Data";]) (var (record [ global "Sta"; global "MemData";])));
       (assign (record [ global "Sta"; global "HomeProc"; global "CacheState";]) (const _CACHE_I));
       (assign (record [ global "Sta"; global "HomeProc"; global "InvMarked";]) (const _TRUE))]) in
   rule name params formula statement
...
let n_NI_Local_GetX_PutX_11 = 
   ...
   let statement =  (parallel [
       ...
       (assign (record [ global "Sta"; global "Dir"; global "HomeInvSet";]) (const _FALSE));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Cmd";]) (const _UNI_PutX));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Data";]) (var (record [ global "Sta"; global "HomeProc"; global "CacheData";])));
       (assign (record [ global "Sta"; global "HomeProc"; global "CacheState";]) (const _CACHE_I))]) in
   rule name params formula statement
...
let n_NI_Remote_GetX_PutX = 
   ...
   let statement =  (parallel [
       ...
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Cmd";]) (const _UNI_PutX));
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "src"])] ; global "Data";]) (var (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "CacheData";])));
       (assign (record [ global "Sta"; global "ShWbMsg"; global "Cmd";]) (const _SHWB_FAck));
       (assign (record [ global "Sta"; global "ShWbMsg"; global "Proc";]) (param (paramref "src")));
       (assign (record [ global "Sta"; global "ShWbMsg"; global "HomeProc";]) (const _FALSE))]) in
   rule name params formula statement
...
let n_NI_Remote_GetX_PutX_Home = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "CacheState";]) (const _CACHE_I));
       (assign (record [ global "Sta"; global "HomeUniMsg"; global "Cmd";]) (const _UNI_PutX));
       (assign (record [ global "Sta"; global "HomeUniMsg"; global "Data";]) (var (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "CacheData";])))]) in
   rule name params formula statement
...
let n_NI_Local_Put = 
   ...
   let statement =  (parallel [
       ...
       (assign (record [ global "Sta"; global "Dir"; global "Dirty";]) (const _FALSE));
       (assign (record [ global "Sta"; global "Dir"; global "Local";]) (const _TRUE));
       (assign (record [ global "Sta"; global "MemData";]) (var (record [ global "Sta"; global "HomeUniMsg"; global "Data";])));
       (assign (record [ global "Sta"; global "HomeProc"; global "ProcCmd";]) (const _NODE_None));
       (ifelseStatement  (eqn (var ( record [ global "Sta"; global "HomeProc"; global "InvMarked";])) (const _TRUE)) (parallel [
               (assign (record [ global "Sta"; global "HomeProc"; global "InvMarked";]) (const _FALSE));
               (assign (record [ global "Sta"; global "HomeProc"; global "CacheState";]) (const _CACHE_I))]) (parallel [
           (assign (record [ global "Sta"; global "HomeProc"; global "CacheState";]) (const _CACHE_S));
           (assign (record [ global "Sta"; global "HomeProc"; global "CacheData";]) (var (record [ global "Sta"; global "HomeUniMsg"; global "Data";])))]))]) in
   rule name params formula statement
...
let n_NI_Remote_Put = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; arr [("UniMsg", [paramref "dst"])] ; global "Cmd";]) (const _UNI_None));
       (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "ProcCmd";]) (const _NODE_None));
       (ifelseStatement  (eqn (var ( record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "InvMarked";])) (const _TRUE)) (parallel [
               (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "InvMarked";]) (const _FALSE));
               (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "CacheState";]) (const _CACHE_I))]) (parallel [
           (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "CacheState";]) (const _CACHE_S));
           (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "CacheData";]) (var (record [ global "Sta"; arr [("UniMsg", [paramref "dst"])] ; global "Data";])))]))]) in
   rule name params formula statement
...
let n_NI_Remote_PutX = 
   ...
   let statement =  (parallel [
       ...
       (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "ProcCmd";]) (const _NODE_None));
       (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "InvMarked";]) (const _FALSE));
       (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "CacheState";]) (const _CACHE_E));
       (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "CacheData";]) (var (record [ global "Sta"; arr [("UniMsg", [paramref "dst"])] ; global "Data";])))]) in
   rule name params formula statement
...
let n_NI_Inv = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; arr [("InvMsg", [paramref "dst"])] ; global "Cmd";]) (const _INV_InvAck));
       (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "CacheState";]) (const _CACHE_I));
       (ifStatement  (eqn (var (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "ProcCmd";])) (const _NODE_Get))
               (assign (record [ global "Sta"; arr [("Proc", [paramref "dst"])] ; global "InvMarked";]) (const _TRUE)))]) in
   rule name params formula statement
...
let n_NI_InvAck_exists_Home = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; arr [("InvMsg", [paramref "src"])] ; global "Cmd";]) (const _INV_None));
       (assign (record [ global "Sta"; global "Dir"; arr [("InvSet", [paramref "src"])] ;]) (const _FALSE))]) in
   rule name params formula statement
...
let n_NI_InvAck_1 = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; arr [("InvMsg", [paramref "src"])] ; global "Cmd";]) (const _INV_None));
       (assign (record [ global "Sta"; global "Dir"; arr [("InvSet", [paramref "src"])] ;]) (const _FALSE));
       (assign (record [ global "Sta"; global "Dir"; global "Pending";]) (const _FALSE));
       (assign (record [ global "Sta"; global "Dir"; global "Local";]) (const _FALSE))]) in
   rule name params formula statement
...
let n_NI_Wb = 
   ...
   let statement =  (parallel [
       ...
       (assign (record [ global "Sta"; global "Dir"; global "Dirty";]) (const _FALSE));
       (assign (record [ global "Sta"; global "Dir"; global "HeadVld";]) (const _FALSE));
       (assign (record [ global "Sta"; global "MemData";]) (var (record [ global "Sta"; global "WbMsg"; global "Data";])))]) in
   rule name params formula statement
...
let n_NI_FAck = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; global "ShWbMsg"; global "Cmd";]) (const _SHWB_None));
       (assign (record [ global "Sta"; global "Dir"; global "Pending";]) (const _FALSE));
       (ifStatement  (eqn (var ( record [ global "Sta"; global "Dir"; global "Dirty";])) (const _TRUE)) (parallel [
               (assign (record [ global "Sta"; global "Dir"; global "HeadPtr";]) (var (record [ global "Sta"; global "ShWbMsg"; global "Proc";])));
               (assign (record [ global "Sta"; global "Dir"; global "HomeHeadPtr";]) (var (record [ global "Sta"; global "ShWbMsg"; global "HomeProc";])))]))]) in
   rule name params formula statement
...
let n_NI_ShWb = 
   ...
   let statement =  (parallel [
       ...
       (assign (record [ global "Sta"; global "Dir"; global "ShrVld";]) (const _TRUE));
       (forStatement 
           (ifelseStatement  (orList [ (andList [ (eqn (param (paramref "p")) (var (record [ global "Sta"; global "ShWbMsg"; global "Proc";]))); (eqn (var ( record [ global "Sta"; global "ShWbMsg"; global "HomeProc";])) (const _FALSE))]); (eqn (var (record [ global "Sta"; global "Dir"; arr [("ShrSet", [paramref "p"])] ;])) (const _TRUE))]) (parallel [
                   (assign (record [ global "Sta"; global "Dir"; arr [("ShrSet", [paramref "p"])] ;]) (const _TRUE));
                   (assign (record [ global "Sta"; global "Dir"; arr [("InvSet", [paramref "p"])] ;]) (const _TRUE))]) (parallel [
               (assign (record [ global "Sta"; global "Dir"; arr [("ShrSet", [paramref "p"])] ;]) (const _FALSE));
               (assign (record [ global "Sta"; global "Dir"; arr [("InvSet", [paramref "p"])] ;]) (const _FALSE))])) [paramdef "p" "NODE"]);
       (ifelseStatement  (orList [ (eqn (var ( record [ global "Sta"; global "ShWbMsg"; global "HomeProc";])) (const _TRUE)); (eqn (var ( record [ global "Sta"; global "Dir"; global "HomeShrSet";])) (const _TRUE))]) (parallel [
               (assign (record [ global "Sta"; global "Dir"; global "HomeShrSet";]) (const _TRUE));
               (assign (record [ global "Sta"; global "Dir"; global "HomeInvSet";]) (const _TRUE))]) (parallel [
           (assign (record [ global "Sta"; global "Dir"; global "HomeShrSet";]) (const _FALSE));
           (assign (record [ global "Sta"; global "Dir"; global "HomeInvSet";]) (const _FALSE))]));
       (assign (record [ global "Sta"; global "MemData";]) (var (record [ global "Sta"; global "ShWbMsg"; global "Data";])))]) in
   rule name params formula statement
...
let n_NI_Replace = 
   ...
   let statement =  (parallel [
       (assign (record [ global "Sta"; arr [("RpMsg", [paramref "src"])] ; global "Cmd";]) (const _RP_None));
       (ifStatement  (eqn (var ( record [ global "Sta"; global "Dir"; global "ShrVld";])) (const _TRUE)) (parallel [
               (assign (record [ global "Sta"; global "Dir"; arr [("ShrSet", [paramref "src"])] ;]) (const _FALSE));
               (assign (record [ global "Sta"; global "Dir"; arr [("InvSet", [paramref "src"])] ;]) (const _FALSE))]))]) in
   rule name params formula statement
...
let n_NI_Replace_Home = 
   ...
   let statement =  (parallel [
       ...
       (ifStatement  (eqn (var ( record [ global "Sta"; global "Dir"; global "ShrVld";])) (const _TRUE)) (parallel [
               (assign (record [ global "Sta"; global "Dir"; global "HomeShrSet";]) (const _FALSE));
               (assign (record [ global "Sta"; global "Dir"; global "HomeInvSet";]) (const _FALSE))]))]) in
   rule name params formula statement
...
let rules = [n_Store; n_Store_Home; n_PI_Remote_Get; n_PI_Local_Get_Get; n_PI_Local_Get_Put; n_PI_Remote_GetX; n_PI_Local_GetX_GetX; n_PI_Local_GetX_PutX_HeadVld; n_PI_Local_GetX_PutX; n_PI_Remote_PutX; n_PI_Local_PutX; n_PI_Remote_Replace; n_PI_Local_Replace; n_NI_Nak; n_NI_Nak_Home; n_NI_Nak_Clear; n_NI_Local_Get_Nak; n_NI_Local_Get_Get; n_NI_Local_Get_Put_Head; n_NI_Local_Get_Put; n_NI_Local_Get_Put_Dirty; n_NI_Remote_Get_Nak; n_NI_Remote_Get_Nak_Home; n_NI_Remote_Get_Put; n_NI_Remote_Get_Put_Home; n_NI_Local_GetX_Nak; n_NI_Local_GetX_GetX; n_NI_Local_GetX_PutX_1; n_NI_Local_GetX_PutX_2; n_NI_Local_GetX_PutX_3; n_NI_Local_GetX_PutX_4; n_NI_Local_GetX_PutX_5; n_NI_Local_GetX_PutX_6; n_NI_Local_GetX_PutX_7; n_NI_Local_GetX_PutX_7_NODE_Get; n_NI_Local_GetX_PutX_8_Home; n_NI_Local_GetX_PutX_8_Home_NODE_Get; n_NI_Local_GetX_PutX_8; n_NI_Local_GetX_PutX_8_NODE_Get; n_NI_Local_GetX_PutX_9; n_NI_Local_GetX_PutX_10_Home; n_NI_Local_GetX_PutX_10; n_NI_Local_GetX_PutX_11; n_NI_Remote_GetX_Nak; n_NI_Remote_GetX_Nak_Home; n_NI_Remote_GetX_PutX; n_NI_Remote_GetX_PutX_Home; n_NI_Local_Put; n_NI_Remote_Put; n_NI_Local_PutXAcksDone; n_NI_Remote_PutX; n_NI_Inv; n_NI_InvAck_exists_Home; n_NI_InvAck_exists; n_NI_InvAck_1; n_NI_InvAck_2; n_NI_InvAck_3; n_NI_Wb; n_NI_FAck; n_NI_ShWb; n_NI_Replace; n_NI_Replace_Home; ]
