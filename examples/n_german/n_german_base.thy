...
"inv__5 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (neg (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv1) ''State'')) (Const I))) (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''State'')) (Const E))))"

definition inv__6::"nat \<Rightarrow> formula" where [simp]:
"inv__6 p__Inv2 \<equiv>
...
"inv__9 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv1) ''State'')) (Const E)) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck))))"
...
"inv__12 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck)) (eqn (IVar (Para (Ident ''ShrSet'') p__Inv2)) (Const false))))"

definition inv__13::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__13 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv1) ''State'')) (Const E)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntS))))"

definition inv__14::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__14 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (neg (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''State'')) (Const I))) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv1) ''Cmd'')) (Const GntE))))"

definition inv__15::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__15 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv1) ''State'')) (Const E)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntE))))"

definition inv__16::"nat \<Rightarrow> formula" where [simp]:
"inv__16 p__Inv2 \<equiv>
...
"inv__19 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv1) ''Cmd'')) (Const GntE)) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck))))"

definition inv__20::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__20 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''State'')) (Const E)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv1) ''Cmd'')) (Const Inv))))"
...
"inv__23 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv1) ''Cmd'')) (Const GntS)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntE))))"
...
"inv__25 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntE)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv1) ''Cmd'')) (Const GntE))))"

definition inv__26::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__26 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntE)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv1) ''Cmd'')) (Const Inv))))"

definition inv__27::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__27 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv1) ''State'')) (Const E)) (eqn (IVar (Para (Ident ''InvSet'') p__Inv2)) (Const true))))"
...
"inv__36 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv1) ''Cmd'')) (Const GntE)) (eqn (IVar (Para (Ident ''InvSet'') p__Inv2)) (Const true))))"

definition inv__37::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__37 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''State'')) (Const E)) (eqn (IVar (Para (Ident ''ShrSet'') p__Inv1)) (Const true))))"
...
"inv__41 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntE)) (eqn (IVar (Para (Ident ''ShrSet'') p__Inv1)) (Const true))))"
...
"inv__45 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv1) ''Cmd'')) (Const Inv)) (eqn (IVar (Ident ''CurCmd'')) (Const ReqS))) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck))))"

definition inv__46::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__46 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv1) ''Cmd'')) (Const InvAck)) (eqn (IVar (Ident ''CurCmd'')) (Const ReqS))) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck))))"

definition inv__47::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__47 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Ident ''CurCmd'')) (Const ReqS)) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv1) ''Cmd'')) (Const InvAck))) (eqn (IVar (Para (Ident ''InvSet'') p__Inv2)) (Const true))))"

definition inv__48::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__48 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Inv)) (eqn (IVar (Ident ''CurCmd'')) (Const ReqS))) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv1) ''Cmd'')) (Const Inv))))"

definition inv__49::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__49 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Ident ''CurCmd'')) (Const ReqS)) (eqn (IVar (Para (Ident ''InvSet'') p__Inv1)) (Const true))) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Inv))))"

definition inv__50::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__50 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Para (Ident ''InvSet'') p__Inv2)) (Const true)) (eqn (IVar (Ident ''ExGntd'')) (Const true))) (eqn (IVar (Para (Ident ''InvSet'') p__Inv1)) (Const true))))"

definition inv__51::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__51 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Para (Ident ''ShrSet'') p__Inv1)) (Const true)) (eqn (IVar (Ident ''ExGntd'')) (Const true))) (eqn (IVar (Para (Ident ''ShrSet'') p__Inv2)) (Const true))))"
