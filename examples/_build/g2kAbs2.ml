...
let rules = [n_SendReqS; n_SendReqEI; n_SendReqES; n_RecvReq; n_SendInvE; n_SendInvS; n_SendInvAck; n_RecvInvAck; n_SendGntS; n_SendGntE; n_RecvGntS; n_RecvGntE; n_Store; n_ASendReqIS; n_ASendReqSE; n_ASendReqEI; n_ASendReqES; n_SendReqEE; n_ARecvReq; n_ASendInvE; n_ASendInvS; n_ASendInvAck; n_ARecvInvAck; n_ASendGntS; n_ASendGntE; n_ARecvGntS; n_ARecvGntE; n_AStore]
...
(*let insym_types = ["NODE"; "boolean"; "AUX_NODE"; "ALL_NODE"] in
