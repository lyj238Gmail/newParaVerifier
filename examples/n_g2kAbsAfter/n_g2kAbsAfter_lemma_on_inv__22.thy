(*  Title:      HOL/Auth/n_g2kAbsAfter_lemma_on_inv__22.thy
...
theory n_g2kAbsAfter_lemma_on_inv__22 imports n_g2kAbsAfter_base
begin
section{*All lemmas on causal relation between inv__22 and some rule r*}
lemma n_n_SendInvE_i1Vsinv__22:
assumes a1: "(r=n_n_SendInvE_i1  )" and
a2: "(f=inv__22  )"
shows "invHoldForRule s f r (invariants N)" (is "?P1 s \<or> ?P2 s \<or> ?P3 s")
proof -
  have "?P3 s"
  apply (cut_tac a1 a2 , simp, rule_tac x="(neg (andForm (andForm (andForm (eqn (IVar (Ident ''ExGntd'')) (Const true)) (neg (eqn (IVar (Field (Ident ''Cache_1'') ''State'')) (Const E)))) (eqn (IVar (Field (Ident ''Chan2_1'') ''Cmd'')) (Const Empty))) (eqn (IVar (Ident ''InvSet_1'')) (Const true))))" in exI, auto) done
  then show "invHoldForRule s f r (invariants N)" by auto
qed

lemma n_n_SendInvS_i1Vsinv__22:
...
lemma n_n_SendInvAck_i1Vsinv__22:
...
lemma n_n_RecvInvAck_i1Vsinv__22:
...
lemma n_n_SendGntS_i1Vsinv__22:
...
lemma n_n_SendGntE_i1Vsinv__22:
...
lemma n_n_RecvGntS_i1Vsinv__22:
...
lemma n_n_RecvGntE_i1Vsinv__22:
...
lemma n_n_ARecvInvAck_i1Vsinv__22:
...
lemma n_n_ASendGntE_i1Vsinv__22:
...
lemma n_n_SendReqEI_i1Vsinv__22:
...
lemma n_n_ASendReqEI_i1Vsinv__22:
...
lemma n_n_ASendReqIS_j1Vsinv__22:
...
lemma n_n_ASendReqES_i1Vsinv__22:
...
lemma n_n_ARecvGntE_i1Vsinv__22:
...
lemma n_n_ASendGntS_i1Vsinv__22:
...
lemma n_n_ARecvGntS_i1Vsinv__22:
...
lemma n_n_ASendInvE_i1Vsinv__22:
...
lemma n_n_ASendInvS_i1Vsinv__22:
...
lemma n_n_SendReqES_i1Vsinv__22:
...
lemma n_n_ASendReqSE_j1Vsinv__22:
...
lemma n_n_SendReqEE_i1Vsinv__22:
...
lemma n_n_ARecvReq_i1Vsinv__22:
...
lemma n_n_SendReqS_j1Vsinv__22:
...
lemma n_n_ASendInvAck_i1Vsinv__22:
