(*  Title:      HOL/Auth/flash_data_cub_lemma_inv__101_on_rules.thy
...
theory flash_data_cub_lemma_inv__101_on_rules imports flash_data_cub_lemma_on_inv__101
begin
section{*All lemmas on causal relation between inv__101*}
lemma lemma_inv__101_on_rules:
  assumes b1: "r \<in> rules N" and b2: "(\<exists> p__Inv3 p__Inv4. p__Inv3\<le>N\<and>p__Inv4\<le>N\<and>p__Inv3~=p__Inv4\<and>f=inv__101  p__Inv3 p__Inv4)"
