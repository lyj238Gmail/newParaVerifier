(*  Title:      HOL/Auth/flash_data_cub_lemma_inv__140_on_rules.thy
...
theory flash_data_cub_lemma_inv__140_on_rules imports flash_data_cub_lemma_on_inv__140
begin
section{*All lemmas on causal relation between inv__140*}
lemma lemma_inv__140_on_rules:
  assumes b1: "r \<in> rules N" and b2: "(f=inv__140  )"
