(*  Title:      HOL/Auth/flash_data_cub_lemma_inv__137_on_rules.thy
...
theory flash_data_cub_lemma_inv__137_on_rules imports flash_data_cub_lemma_on_inv__137
begin
section{*All lemmas on causal relation between inv__137*}
lemma lemma_inv__137_on_rules:
  assumes b1: "r \<in> rules N" and b2: "(\<exists> p__Inv4. p__Inv4\<le>N\<and>f=inv__137  p__Inv4)"
