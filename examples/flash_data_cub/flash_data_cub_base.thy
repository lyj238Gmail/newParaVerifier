(*  Title:      HOL/Auth/flash_data_cub_base.thy
...
theory flash_data_cub_base imports paraTheory
begin
...
(neg (andForm (eqn (IVar (Field (Field (Ident ''Sta'') ''Dir'') ''Dirty'')) (Const false)) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''Cmd'')) (Const UNI_PutX))))"
...
(neg (andForm (eqn (IVar (Field (Field (Ident ''Sta'') ''HomeUniMsg'') ''Cmd'')) (Const UNI_PutX)) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''Cmd'')) (Const UNI_PutX))))"
...
(neg (andForm (eqn (IVar (Field (Field (Ident ''Sta'') ''HomeUniMsg'') ''Cmd'')) (Const UNI_Put)) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''Cmd'')) (Const UNI_PutX))))"
...
definition inv__63::"nat \<Rightarrow> formula" where [simp]:
"inv__63 p__Inv4 \<equiv>
...
definition inv__68::"nat \<Rightarrow> formula" where [simp]:
"inv__68 p__Inv4 \<equiv>
...
definition inv__79::"nat \<Rightarrow> formula" where [simp]:
"inv__79 p__Inv4 \<equiv>
...
"inv__80  \<equiv>
(neg (andForm (eqn (IVar (Field (Field (Ident ''Sta'') ''NakcMsg'') ''Cmd'')) (Const NAKC_Nakc)) (eqn (IVar (Field (Field (Ident ''Sta'') ''HomeUniMsg'') ''Cmd'')) (Const UNI_GetX))))"
...
(neg (andForm (andForm (eqn (IVar (Field (Field (Ident ''Sta'') ''ShWbMsg'') ''Cmd'')) (Const SHWB_ShWb)) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''Cmd'')) (Const UNI_Get))) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''HomeProc'')) (Const false))))"

definition inv__98::"nat \<Rightarrow> formula" where [simp]:
"inv__98 p__Inv4 \<equiv>
(neg (andForm (andForm (eqn (IVar (Field (Field (Ident ''Sta'') ''NakcMsg'') ''Cmd'')) (Const NAKC_Nakc)) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''Cmd'')) (Const UNI_Get))) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''HomeProc'')) (Const false))))"
...
definition inv__101::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__101 p__Inv3 p__Inv4 \<equiv>
...
definition inv__103::"formula" where [simp]:
"inv__103  \<equiv>
...
(neg (andForm (andForm (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''Cmd'')) (Const UNI_GetX)) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''HomeProc'')) (Const false))) (eqn (IVar (Field (Field (Ident ''Sta'') ''HomeUniMsg'') ''Cmd'')) (Const UNI_GetX))))"

definition inv__109::"formula" where [simp]:
"inv__109  \<equiv>
...
(neg (andForm (andForm (eqn (IVar (Field (Field (Ident ''Sta'') ''Dir'') ''Pending'')) (Const false)) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''Cmd'')) (Const UNI_GetX))) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''HomeProc'')) (Const false))))"

definition inv__113::"nat \<Rightarrow> formula" where [simp]:
"inv__113 p__Inv4 \<equiv>
(neg (andForm (eqn (IVar (Field (Field (Ident ''Sta'') ''NakcMsg'') ''Cmd'')) (Const NAKC_Nakc)) (eqn (IVar (Para (Field (Field (Ident ''Sta'') ''Dir'') ''InvSet'') p__Inv4)) (Const true))))"

definition inv__114::"formula" where [simp]:
"inv__114  \<equiv>
...
(neg (andForm (eqn (IVar (Field (Field (Ident ''Sta'') ''Dir'') ''ShrVld'')) (Const true)) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''Proc'') p__Inv4) ''CacheState'')) (Const CACHE_E))))"

definition inv__128::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__128 p__Inv3 p__Inv4 \<equiv>
...
(neg (andForm (andForm (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''Cmd'')) (Const UNI_GetX)) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''HomeProc'')) (Const false))) (eqn (IVar (Para (Field (Field (Ident ''Sta'') ''Dir'') ''InvSet'') p__Inv4)) (Const true))))"

definition inv__134::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__134 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (andForm (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv3) ''Cmd'')) (Const UNI_GetX)) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv3) ''HomeProc'')) (Const false))) (eqn (IVar (Para (Field (Field (Ident ''Sta'') ''Dir'') ''InvSet'') p__Inv4)) (Const true))))"

definition inv__135::"nat \<Rightarrow> formula" where [simp]:
"inv__135 p__Inv4 \<equiv>
...
definition inv__137::"nat \<Rightarrow> formula" where [simp]:
"inv__137 p__Inv4 \<equiv>
(neg (andForm (eqn (IVar (Field (Field (Ident ''Sta'') ''NakcMsg'') ''Cmd'')) (Const NAKC_Nakc)) (eqn (IVar (Para (Field (Field (Ident ''Sta'') ''Dir'') ''ShrSet'') p__Inv4)) (Const true))))"
...
definition inv__140::"formula" where [simp]:
"inv__140  \<equiv>
...
(neg (andForm (eqn (IVar (Field (Field (Ident ''Sta'') ''Dir'') ''HeadVld'')) (Const false)) (eqn (IVar (Para (Field (Field (Ident ''Sta'') ''Dir'') ''ShrSet'') p__Inv4)) (Const true))))"
...
definition inv__144::"formula" where [simp]:
"inv__144  \<equiv>
...
definition inv__145::"formula" where [simp]:
"inv__145  \<equiv>
...
definition inv__153::"nat \<Rightarrow> formula" where [simp]:
"inv__153 p__Inv4 \<equiv>
...
(neg (andForm (andForm (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''Cmd'')) (Const UNI_GetX)) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''HomeProc'')) (Const false))) (eqn (IVar (Para (Field (Field (Ident ''Sta'') ''Dir'') ''ShrSet'') p__Inv4)) (Const true))))"

definition inv__155::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__155 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (andForm (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''Cmd'')) (Const UNI_GetX)) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv4) ''HomeProc'')) (Const false))) (eqn (IVar (Para (Field (Field (Ident ''Sta'') ''Dir'') ''ShrSet'') p__Inv3)) (Const true))))"

definition inv__156::"nat \<Rightarrow> formula" where [simp]:
"inv__156 p__Inv4 \<equiv>
...
definition inv__157::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__157 p__Inv3 p__Inv4 \<equiv>
...
definition inv__160::"formula" where [simp]:
"inv__160  \<equiv>
