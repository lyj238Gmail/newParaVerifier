(*  Title:      HOL/Auth/flash_data_cub_lemma_on_inv__63.thy
...
theory flash_data_cub_lemma_on_inv__63 imports flash_data_cub_base
begin
section{*All lemmas on causal relation between inv__63 and some rule r*}
lemma n_PI_Local_Get_GetVsinv__63:
assumes a1: "(r=n_PI_Local_Get_Get  )" and
a2: "(\<exists> p__Inv4. p__Inv4\<le>N\<and>f=inv__63  p__Inv4)"
shows "invHoldForRule s f r (invariants N)" (is "?P1 s \<or> ?P2 s \<or> ?P3 s")
proof -
from a2 obtain p__Inv4 where a2:"p__Inv4\<le>N\<and>f=inv__63  p__Inv4" apply fastforce done
  have "?P1 s"
