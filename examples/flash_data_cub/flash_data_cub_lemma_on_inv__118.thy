(*  Title:      HOL/Auth/flash_data_cub_lemma_on_inv__118.thy
...
theory flash_data_cub_lemma_on_inv__118 imports flash_data_cub_base
begin
...
a2: "(\<exists> p__Inv4. p__Inv4\<le>N\<and>f=inv__118  p__Inv4)"
shows "invHoldForRule s f r (invariants N)" (is "?P1 s \<or> ?P2 s \<or> ?P3 s")
proof -
from a2 obtain p__Inv4 where a2:"p__Inv4\<le>N\<and>f=inv__118  p__Inv4" apply fastforce done
  have "?P1 s"
...
from a2 obtain p__Inv4 where a2:"p__Inv4\<le>N\<and>f=inv__118  p__Inv4" apply fastforce done
  have "?P3 s"
  apply (cut_tac a1 a2 , simp, rule_tac x="(neg (andForm (eqn (IVar (Field (Field (Ident ''Sta'') ''Dir'') ''HeadVld'')) (Const false)) (eqn (IVar (Para (Field (Field (Ident ''Sta'') ''Dir'') ''ShrSet'') p__Inv4)) (Const true))))" in exI, auto) done
  then show "invHoldForRule s f r (invariants N)" by auto
qed
